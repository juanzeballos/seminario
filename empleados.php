...
?>
	...
	<div class="container-fluid">
          ...
          <nav class="navbar-nav">
             ...
             <li class="nav-item  dropdown ">
         		...
         		<div class="dropdown-menu bg-dark menu-activo ">
        	    	...
        	    	<a class="dropdown-item text-light active bg-secondary" href="empleado.php active">Empleado</a>
		...
		<div class="row mb-4 mt-5">	
			...
			Fecha: <input type="month" id="fechaEmpleados" name="fechaEmpleados"  value="<?php echo date_format("d/m/Y")?>">
			...
			<?php
			include ('config.php');
			$registroEmpleados=mysqli_query($conexion,"select nomb_empleados, monto_empleados,fechaEmpleados from empleados");
			$totalEmpleados=0;
			if (isset($_POST['fechaEmpleados'])) 
			{
				?>
				...
				{
					$newDate = date("Y-m", strtotime($reg['fechaEmpleados'])) ;

					if ($newDate == $_POST['fechaEmpleados'] )
					 {
						
						$totalEmpleados = $totalEmpleados + $reg['monto_empleados'];
						
						?>
							
						
							<tr>
								<td><?php echo $reg['nomb_empleados'] ." " ;?>
								</td>
							
								<td> <?php echo $reg['monto_empleados'] ." " ;?>						
								</td>

								<td><?php echo $fechaEmpleado = date("d/m", strtotime($reg['fechaEmpleados']))." ";?> 
								</td>
								 <?php echo "<br>";?>
							 </tr>
			 ...
			 echo "<tr><td class='text-right'>Total :</td>
			 	<td>". $totalEmpleados
			 	." 
			 </tbody>	 
						 </table>" ; 
